  ...
  >
    <template #header>
      <span class="icon-wrap">
        ...
        <tiny-button type="primary" @click="saveSchema">{{ t('designer.schema.save') }}</tiny-button>
      </span>
      <tiny-popover v-show="false" placement="bottom" trigger="hover" append-to-body :content="t('designer.schema.importSchema')">
        <template #reference>
          <span class="icon-wrap">
