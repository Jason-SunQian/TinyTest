<template>
  ...
  >
    <template #header>
      <button-group>
        <tiny-button type="primary" @click="saveFolderSetting">{{ t('designer.page.save') }}</tiny-button>
        <svg-button
    ...
    <template #content>
      <div class="page-setting-content">
        <tiny-collapse v-model="state.activeName">
          <tiny-collapse-item :title="t('designer.page.basicSettings')" name="folderGeneralRef">
