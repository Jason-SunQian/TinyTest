<template>
  <div class="general-config">
    ...
    >
      ...
      <tiny-form-item prop="name" :label="isFolder ? t('designer.page.folderName') : t('designer.page.pageName')">
        <tiny-input
          v-model="pageSettingState.currentPageData.name"
          :placeholder="isFolder ? t('designer.page.enterFolderName') : t('designer.page.enterPageName')"
        ></tiny-input>
      </tiny-form-item>
      ...
      <tiny-form-item :label="t('designer.page.pageRoute')" prop="route">
        <tiny-input v-model="pageSettingState.currentPageData.route" :placeholder="t('designer.page.enterRoute')"> </tiny-input>
        <div class="tip">
          <span class="text" v-if="!pageSettingState.currentPageData.route">{{ t('designer.page.routeStartsWith') }}</span>
      ...
      >
        ...
        <div v-if="state.defaultPageId" class="tip">
          <div class="tip-text">{{ t('designer.page.accessRoute') }}</div>
          <span class="tip-text-dim">/{{ currentRoute }}</span>
          <div class="tip-text">{{ t('designer.page.defaultRedirectTo') }}</div>
...
export default {
  ...
  setup() {
    ...
    const folderRules = {
      ...
      route: [
        { required: true, message: t('designer.page.enterFolderRoute') },
        {
          pattern: REGEXP_ROUTE,
          message: t('designer.page.routeRule')
        }
      ],
      group: [{ required: true, message: t('designer.page.selectPageTypeRequired') }]
    }
    ...
    const treeFolderOp = computed(() => {
      ...
      const dummyRoot = pageToTreeData({ children: [{ name: t('designer.page.none'), id: ROOT_ID }].concat(staticPages) })
