...
const getPageList = async (appId?: string) => {
  ...
  const firstGroupData: GroupData = { groupName: t('designer.page.staticPages'), groupId: STATIC_PAGE_GROUP_ID, data: [] }
  const secondGroupData: GroupData = { groupName: t('designer.page.publicPages'), groupId: COMMON_PAGE_GROUP_ID, data: [] }
