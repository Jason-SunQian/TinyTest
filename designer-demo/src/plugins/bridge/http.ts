...
// 资源管理 -- 新增
export const requestAddReSource = (params) => getMetaApi(META_SERVICE.Http).post('/app-center/api/apps/extension/create', params)

// 资源管理 -- 修改
export const requestUpdateReSource = (params) => getMetaApi(META_SERVICE.Http).post(`/app-center/api/apps/extension/update`, params)

// 资源管理 -- 删除
export const requestDeleteReSource = (params) => getMetaApi(META_SERVICE.Http).get(`/app-center/api/apps/extension/delete?${params}`)
