    ...
    <div class="manage-panel">
        <div class="manage-panel-search">
            <tiny-search
                ...
                @update:model-value="searchBridgeData"
            >
                <template #prefix>
                    <tiny-icon-search />
                </template>
        ...
        <div class="list lowcode-scrollbar">
            ...
            <search-empty :is-show="!list.length" />
        </div>
    </div>
</template>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const filterResourceSearchValue = (
        ...
        const refresh = async name => {
            ...
            setResourceNamesByType(
                name,
                Array.isArray(state.resourceList)
                    ? state.resourceList.map(r => r.name)
                    : []
            );
...
.list-item:hover .setting-icon,
.list-item.active .setting-icon {
    display: grid;
}
.list-item-icon {
