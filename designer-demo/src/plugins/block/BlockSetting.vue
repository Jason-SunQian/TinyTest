<template>
  ...
  >
    <template #header>
      <button-group>
        <tiny-button @click="updateBlock">{{ t('designer.common.save') }}</tiny-button>
        <tiny-button
          type="primary"
        ...
        <svg-button name="delete" :tips="t('designer.common.delete')" placement="top" @click="deleteBlock"></svg-button>
        <close-icon @click="closePanel"></close-icon>
      </button-group>
    </template>
    <template #content>
      <tiny-collapse v-model="state.activeName">
        <tiny-collapse-item :title="t('designer.block.basicSettings')" name="base">
          <block-config ref="blockConfigForm"></block-config>
        </tiny-collapse-item>
        <tiny-collapse-item name="attribute">
          <template #title>
            <div class="title-wrapper">
              <span>{{ t('designer.block.attributeSettings') }}</span>
            </div>
          </template>
            ...
            <block-property :show-video="state.showAttributeGuide">
              <template #video>
                <div class="video-close" @click.stop="handleShowGuide('showAttributeGuide')">
                  <span class="close-text">{{ t('designer.common.collapse') }}</span>
        ...
        <tiny-collapse-item :title="t('designer.block.eventSettings')" name="event">
          <template #title>
            <div class="title-wrapper">
        ...
        <tiny-collapse-item :title="t('designer.block.lifecycleSettings')" name="lifeCycle">
        ...
        <tiny-collapse-item :title="t('designer.block.versionList')" name="history">
          <block-history-list
