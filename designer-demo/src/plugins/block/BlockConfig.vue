<template>
  ...
  >
    ...
    <tiny-form-item :label="t('designer.block.blockId')" prop="label">
      <div>
        <tiny-input v-model="formData.label" :placeholder="t('designer.block.placeholderBlockId')" disabled></tiny-input>
      </div>
      <div class="global-desc-info">{{ t('designer.block.blockIdDescription') }}</div>
    </tiny-form-item>
    <tiny-form-item :label="t('designer.block.blockDescription')" prop="description">
      <div>
        <tiny-input
          v-model="formData.description"
          :placeholder="t('designer.block.placeholderBlockDescription')"
    ...
    <tiny-form-item :label="t('designer.block.blockTags')" prop="tags">
      <div class="block-tag-create">
        ...
        <tiny-button v-show="!state.inputVisible" class="button-new-tag" size="small" @click="addTag">
          <svg-icon name="add"></svg-icon>{{ t('designer.block.tag') }}
        </tiny-button>
      </div>
      <div class="global-desc-info">{{ t('designer.block.tagDescription') }}</div>
    </tiny-form-item>
    <tiny-form-item :label="t('designer.block.publicScope')" prop="openness">
      <div class="block-openness">
        <div class="block-openness-public">
          ...
          >
          <tiny-radio v-model="formData.public" :label="BLOCK_OPENNESS.Open" @change="changeOpenness">{{ t('designer.block.public') }}</tiny-radio>
          ...
          <div v-show="formData.public === BLOCK_OPENNESS.Special" class="block-openness-tenants">
            <tiny-select
              ...
              :placeholder="t('designer.block.selectOrganization')"
              filterable
              collapse-tags
              multiple
      ...
      <div class="global-desc-info">{{ t('designer.block.publicScopeDescription') }}</div>
    </tiny-form-item>
  </tiny-form>
</template>
...
export default {
  ...
  setup() {
    ...
    const rules = {
      name_cn: [{ required: true, message: t('designer.block.required'), trigger: 'blur' }]
    }
