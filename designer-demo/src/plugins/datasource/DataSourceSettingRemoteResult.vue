<template>
  <div class="remote">
    <plugin-setting :title="t('designer.datasource.viewRemoteFieldsTitle')" class="remote-setting" :align="align" :isSecond="true">
      <template #header>
        <button-group>
          <tiny-button class="field-save" type="primary" @click="saveMapping">{{ t('designer.common.save') }}</tiny-button>
      ...
      <template #content>
        <div class="create-config">
          <div class="item">
            <div class="item-title">{{ t('designer.datasource.requestResult') }}</div>
          ...
          <div class="item">
            <div class="item-title field">{{ t('designer.datasource.viewFields') }}</div>
