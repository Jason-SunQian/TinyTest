<template>
    <div class="right-item">
        <span class="title">{{
            t('designer.datasource.dataSourceTemplate')
        }}</span>
        <div class="tips">
            <span class="blue">{{
                t('designer.datasource.blueBoxRepresentsArray')
            }}</span>
            <span class="green">{{
                t('designer.datasource.greenBoxRepresentsTree')
            }}</span>
        </div>
        <ul class="templates">
