<template>
    <div class="right-item">
        <span class="title">
            <span class="title">{{
                t('designer.datasource.dataSourceFields')
            }}</span>
            <div class="btn">
                <tiny-button @click="openNewFieldForm"><svg-icon name="add" />{{
...
import DataSourceFieldType, {
    open as openFieldType
} from './DataSourceFieldType.vue';
