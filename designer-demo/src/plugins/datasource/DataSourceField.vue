<template>
  <div class="right-item">
    <span class="title">
      <span class="title">{{ t('designer.datasource.dataSourceFields') }}</span>
      <div class="btn">
        <tiny-button @click="openNewFieldForm"><svg-icon name="add"></svg-icon>{{ t('designer.datasource.addField') }}</tiny-button>
      </div>
    </span>
    <div class="section">
