    ...
    <div class="field-row field-row-border-bottom-none">
      <div class="icon-and-text">
        ...
        <div class="field-cell-name">
          <span>{{ t('designer.datasource.selectFieldType') }}</span>
        </div>
      </div>
      <span class="btn" @click="cancelSelectType">{{ t('designer.common.cancel') }}</span>
    </div>
    <div class="type-list">
      <div v-for="fieldType in fieldTypeOptions" :key="fieldType.name" class="type-item" @click="selectType(fieldType)">
