<template>
  <div class="right-item">
    ...
    >
      <tiny-form-item prop="name" :label="t('designer.datasource.dataSourceName')">
        <tiny-input v-model="state.dataSource.name" :placeholder="t('designer.datasource.enterDataSourceName')" @input="modifyName"></tiny-input>
      </tiny-form-item>
    </tiny-form>
  </div>
</template>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const rules = computed(() => ({
      name: [
        { required: true, message: t('designer.datasource.dataSourceNameRequired'), trigger: 'change' },
        {
          type: 'string',
