  ...
  >
    <tiny-form-item :label="t('designer.datasource.apiUrl')" prop="uri">
      <div class="textarea-warp">
        ...
        <tiny-input class="border-input" v-model="state.serviceForm.uri" resize="none" :placeholder="t('designer.datasource.enterApiUrl')">
        </tiny-input>
      </div>
    </tiny-form-item>
    <tiny-form-item :label="t('designer.datasource.requestDescription')" prop="description">
      <tiny-input type="textarea" v-model="state.serviceForm.description" :placeholder="t('designer.datasource.enterRequestDescription')"></tiny-input>
    </tiny-form-item>
  </tiny-form>
</template>
...
export default {
  ...
  setup(props) {
    ...
    const rules = computed(() => ({
      uri: [{ required: true, message: t('designer.datasource.dataSourceNameRequired'), trigger: ['blur'] }],
      method: { required: true, message: t('designer.datasource.required'), trigger: ['blur'] }
    }))
