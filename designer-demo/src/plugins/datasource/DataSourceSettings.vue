<template>
  <div class="data-source-setting">
    <tiny-tabs v-model="state.activeTabName" @click="tabClick">
      <tiny-tab-item :title="t('designer.datasource.remoteConfig')" name="remote" v-if="showRemote">
        <div>
      ...
      <tiny-tab-item :title="t('designer.datasource.dataSourceFields')" name="field">
        <div>
          <data-source-field v-model="state.dataSource.data.columns" :editable="editable"></data-source-field>
        </div>
      </tiny-tab-item>
      <tiny-tab-item :title="t('designer.datasource.staticData')" name="record">
