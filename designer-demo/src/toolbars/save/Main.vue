        ...
        <tiny-popover :visible-arrow="false" width="203" trigger="click" :open-delay="OPEN_DELAY.Default">
          ...
          <div class="save-style">
            ...
            <div class="save-time">
              ...
              <tiny-select v-model="state.timeValue" :options="delayOptions" :disabled="!state.checked" autocomplete="off">
              </tiny-select>
            </div>
...
import { openCommon, saveCommon } from './js'
import { isLoading, setAutoSaveStatus, getAutoSaveStatus } from './js'
