    ...
    <template #default>
      <div class="toolbar-wrap">
        ...
        <tiny-popover v-if="isCanvas" width="200" trigger="click" popper-class="toolbar-media-popper">
          <template #reference>
            <span class="reference-text" :title="t('designer.toolbar.media.canvasSettings')">
              <span>
          ...
          <div class="content-wrap text-content">
            <div class="title text-title">{{ t('designer.toolbar.media.canvasSettings') }}</div>
            <div class="setting">
              <div>
                <label>{{ t('designer.toolbar.media.width') }}</label>
              ...
              <div>
                <label>{{ t('designer.toolbar.media.scale') }}</label>
              ...
              <div>
                <label>{{ t('designer.toolbar.media.freeLayout') }}</label>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const mediaMap = computed(() => {
      return media.value.reduce((output: any, obj, index) => {
