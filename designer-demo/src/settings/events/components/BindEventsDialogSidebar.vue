<template>
  <div class="dialog-content-left">
    <div class="left-title">{{ t('designer.settings.events.dialog.sidebar.title') }}</div>
    <div class="left-list-wrap">
      <div class="left-action-list">
        <tiny-search v-model="searchValue" :placeholder="t('designer.settings.events.dialog.sidebar.searchPlaceholder')"></tiny-search>
...
export default {
  ...
  setup(props) {
    ...
    watchEffect(() => {
      ...
      const newMethod = {
        title: t('designer.settings.events.dialog.sidebar.addNewMethod'),
        name: newMethodName,
