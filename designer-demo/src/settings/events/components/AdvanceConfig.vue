<template>
  <div class="advanced-config-container">
    <div class="advnce-config">
      <label class="text-ellipsis-multiple">{{ t('designer.settings.events.advanced.render') }}</label>
      <div class="advanced-config-form-item">
        ...
        <div v-else class="binding-state text-ellipsis-multiple" :title="condition.value">
          {{ t('designer.settings.events.advanced.bound', { value: condition.value }) }}
        </div>
    ...
    <div class="advnce-config loop-data-item">
      <label class="text-ellipsis-multiple">{{ t('designer.settings.events.advanced.loopData') }}</label>
      <div class="advanced-config-form-item">
        <code-configurator
          v-if="!state.isLoop"
        ...
        <div v-else class="binding-state text-ellipsis-multiple" :title="state.loopData?.value">
          {{ t('designer.settings.events.advanced.bound', { value: state.loopData?.value }) }}
        </div>
        <variable-configurator
          v-model="state.loopData"
          name="advance"
    ...
    <div class="advnce-config">
      <label class="text-ellipsis-multiple">{{ t('designer.settings.events.advanced.loopItem') }}</label>
      <div class="advanced-config-form-item">
        <input-configurator
          v-model="state.loopItem"
          :placeholder="t('designer.settings.events.advanced.defaultValue', { value: DEFAULT_LOOP_NAME.ITEM })"
          @update:modelValue="setLoopItem"
        ></input-configurator>
      </div>
    </div>
    <div class="advnce-config">
      <label class="text-ellipsis-multiple">{{ t('designer.settings.events.advanced.loopIndex') }}</label>
      <div class="advanced-config-form-item">
        <input-configurator
          v-model="state.loopIndex"
          :placeholder="t('designer.settings.events.advanced.defaultValue', { value: DEFAULT_LOOP_NAME.INDEX })"
          @update:modelValue="setLoopIndex"
        ></input-configurator>
      </div>
    </div>
    <div class="advnce-config">
      <label class="text-ellipsis-multiple">{{ t('designer.settings.events.advanced.loopKey') }}</label>
      <div class="advanced-config-form-item">
        <tiny-tooltip :content="t('designer.settings.events.advanced.loopKeyTooltip')" effect="light">
          <input-configurator
            v-model="state.loopKey"
            :placeholder="t('designer.settings.events.advanced.defaultIndexName', { value: getIndexName() })"
