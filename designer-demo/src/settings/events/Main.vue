  ...
  >
    <template #content>
      <tiny-collapse v-model="activeNames">
        <tiny-collapse-item :title="t('designer.settings.events.sections.binding')" name="bindEvent">
          <bind-events></bind-events>
        </tiny-collapse-item>
        <tiny-collapse-item :title="t('designer.settings.events.sections.advanced')" name="advancedConfig">
