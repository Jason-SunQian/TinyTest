    ...
    <template #content>
      <div class="style-editor">
        <div class="line-style">
          <span class="line-text"> {{ t('designer.settings.styles.inlinePanel') }} </span>
      ...
      <tiny-collapse v-model="activeNames" @change="handoverGroup">
        <tiny-collapse-item :title="t('designer.settings.styles.groups.layout')" name="layout">
        ...
        <tiny-collapse-item :title="t('designer.settings.styles.groups.spacing')" name="spacing">
          <spacing-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.size')" name="size">
          <size-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.position')" name="position">
          <position-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.typography')" name="typography">
          <typography-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.background')" name="backgrounds">
          <background-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.border')" name="borders">
          <border-group :style="state.style" @update="updateStyle" />
        </tiny-collapse-item>

        <tiny-collapse-item :title="t('designer.settings.styles.groups.effects')" name="effects" class="effects-style">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const updateInlineTexts = (boundValue) => {
      ...
      if (boundValue) {
        state.propertiesList = t('designer.settings.styles.inlineBound', { value: boundValue })
      } else {
        state.propertiesList = t('designer.settings.styles.inlinePlaceholder')
      }
    }
