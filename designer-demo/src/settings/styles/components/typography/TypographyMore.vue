                        ...
                        <div class="item-col">
                            <div class="item-btn">
                                ...
                                <tiny-tooltip
                                    :effect="effect"
                                    :placement="placement"
                                    content="Capitalize Every Word"
                                >
                                    <div class="icon">
                                        <svg-icon
                                            name="text-transform-sentence"
                                            class="bem-Svg"
                                        />
                                    </div>
                                </tiny-tooltip>
...
<!-- eslint-disable vue/block-lang, vue/component-api-style, @typescript-eslint/naming-convention, new-cap, vue/max-lines-per-block, vue/require-typed-object-prop -->
<script lang="ts">
