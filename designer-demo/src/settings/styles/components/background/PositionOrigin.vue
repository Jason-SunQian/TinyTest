<!-- eslint-disable vue/no-bare-strings-in-template, vue/block-lang, vue/component-api-style, @typescript-eslint/naming-convention, vue/require-explicit-emits -->
<template>
        ...
        <div class="position-content">
            ...
            <div class="input-wrap">
                <div class="input-item-wrap">
                    ...
                    <input-select
                        :model-value="state.leftValue"
                        :suffix-value="state.leftSuffix"
                ...
                <div class="input-item-wrap">
                    ...
                    <input-select
                        :model-value="state.topValue"
                        :suffix-value="state.topSuffix"
        ...
        const updatePositionStyle = () => {
            const styleObj = {
                [BACKGROUND_PROPERTY.BackgroundPosition]: `${
                    state.leftValue + state.leftSuffix
