    ...
    <div class="background-image-gradient">
        <div class="slider" :style="style">
            <div class="slider-inner">
                ...
                <div
                    class="delta-left"
                    :style="{ backgroundColor: state.gradientLeftColor }"
                >
                    <div class="delta-inner" />
                </div>
            </div>
        ...
        <div class="repeat">
            <div>
                <tiny-checkbox v-model="state.repeat" @change="changeRepeat">{{
                    t('designer.settings.repeat')
                }}</tiny-checkbox>
            </div>
            <span><svg-icon name="restart" /></span>
        </div>
        <div class="color">
            <label for="">{{ t('designer.settings.color') }}</label>
            <color-configurator
                :model-value="state.colorValue"
                @change="colorChange"
            />
            <tiny-input
                v-model="state.value"
