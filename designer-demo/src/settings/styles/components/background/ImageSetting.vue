...
<template>
    ...
    <div class="background-row line">
        ...
        <tabs-group-configurator
            ...
            :model-value="state.sizeSelected"
            label-width="67"
    ...
    <div class="size-row">
        <div class="size-col">
            ...
            <input-select
                ...
                :suffix-value="state.widthSuffix"
        ...
        <div class="size-col">
            ...
            <input-select
                ...
                :suffix-value="state.heightSuffix"
                :options="UNIT_OPTIONS"
                :disabled="state.sizeSelected !== 'custom'"
    ...
    <div class="background-row tile-wrap">
        ...
        <tabs-group-configurator
            ...
            :model-value="state.repeat"
            label-width="50"
            @update:model-value="selectRepeat"
        />
    </div>
    <div class="background-row fixed-wrap">
        ...
        <tabs-group-configurator
            ...
            :model-value="state.fixedSelected"
            label-width="98"
            @update:model-value="selectFixed"
        />
    </div>
</template>

<!-- eslint-disable vue/max-lines-per-block, vue/block-lang, @typescript-eslint/prefer-destructuring, vue/define-props-declaration, vue/require-typed-object-prop, vue/define-emits-declaration -->
...
const setBackgroundSize = () => {
    ...
    const width = isAutoWidth
        ? state.width.toLocaleLowerCase()
        : `${state.width.toLocaleLowerCase() + state.widthSuffix}`;
...
onMounted(() => {
    ...
    state.imgUrl = backgroundImageStr
        ? backgroundImageStr.substring(4, backgroundImageStr.length - 1)
        : '';
