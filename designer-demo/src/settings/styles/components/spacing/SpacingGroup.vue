    ...
    <div class="spacing-wrap">
        <div class="spacing-max-icon">
            ...
            "
                            ...
                            class="padding-color"
                            @click="
                                clickMargin(SPACING_PROPERTY.MarginTop, $event)
                            "
                        />
                    </g>
                </g>
            ...
            "
                            ...
                            class="margin-color"
                            @click="
                                clickMargin(SPACING_PROPERTY.MarginLeft, $event)
                            "
                        />
                    </g>
                </g>
                ...
                :class="[
                    ...
                    'margin-top',
                    {
                        'is-setting': getSettingFlag(
                            SPACING_PROPERTY.MarginTop
                        ),
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.MarginTop
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    'margin-right',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.MarginRight
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    'margin-bottom',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.MarginBottom
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    {
                        'is-setting': getSettingFlag(
                            SPACING_PROPERTY.MarginLeft
                        ),
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.MarginLeft
                    }
                ]"
        ...
        <div class="spacing-min-icon">
            ...
            "
                            ...
                            @click="
                                clickPadding(
                                    SPACING_PROPERTY.PaddingBottom,
                                    $event
                                )
                            "
                        />
            ...
            <div
                :class="[
                    ...
                    'padding-top',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.PaddingTop
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    'padding-right',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.PaddingRight
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    'padding-bottom',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.PaddingBottom
                    }
                ]"
            ...
            <div
                :class="[
                    ...
                    'padding-left',
                    {
                        ...
                        'is-show':
                            state.show &&
                            state.className === SPACING_PROPERTY.PaddingLeft
                    }
                ]"
...
<!-- eslint-disable vue/max-lines-per-block, vue/block-lang, vue/component-api-style, @typescript-eslint/naming-convention, max-lines, no-inline-comments, line-comment-position -->
<script lang="ts">
...
export default {
    ...
    setup(props, { emit }) {
            ...
            Object.values(SPACING_PROPERTY).forEach(name => {
                ...
                properties[name] = {
                    ...
                    text:
                        value === 'auto'
                            ? 'auto'
                            : String(Number.parseInt(value) || 0), // 界面 box 中显示的数值
        ...
        const getSettingFlag = styleName =>
            Boolean(spacing.value[styleName]?.setting);
        const getPropertyText = styleName =>
            spacing.value[styleName]?.text || 0;
