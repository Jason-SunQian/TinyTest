<template>
    ...
    <div v-if="state.activedType && state.activedType !== 'none'" class="outline-setting">
      <div class="outline-row-wrap">
        <div class="left outline-width">
          <label class="outline-label"><span>{{ t('designer.settings.styles.effects.width') }}</span></label>
          <input-select
        ...
        <div class="right outline-width">
          <label class="outline-label"><span>{{ t('designer.settings.styles.effects.offset') }}</span></label>
          <input-select
      ...
      <div class="outline-color">
        <label class="outline-label"><span>{{ t('designer.settings.styles.effects.color') }}</span></label>
  ...
  <div class="effect-group line cursor-wrap">
    ...
    <div>
      <tiny-select v-model="state.cursorValue" :placeholder="t('designer.settings.styles.effects.selectPlaceholder')" @change="cursorChange">
        <tiny-option-group
