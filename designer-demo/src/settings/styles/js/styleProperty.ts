...
export const RADIAL_SIZE_LIST = [
    {
        content:
            'Closest side extends the gradient from the defined position to the closest side.',
        icon: 'closest-side',
        value: 'closest-side'
    },
    {
        content:
            'Closest corner extends the gradient from the defined position to the closest corner.',
        icon: 'closest-corner',
    ...
    {
        content:
            'Farthest corner extends the gradient from the defined position to the farthest corner.',
