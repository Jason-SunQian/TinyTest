...
<!-- eslint-disable vue/block-lang, vue/component-api-style, vue/html-self-closing, import/order, vue/require-typed-object-prop -->
<template>
    <div
    ...
    <div
        v-if="state.showDividerLine"
        class="divider-line"
        :style="state.dividerStyle"
    ></div>
</template>
