    ...
    >
      <template #reference>
        <tiny-button class="life-cycle-btn"
          ><svg-icon name="add"></svg-icon>{{ isPage ? t('designer.components.lifeCycles.addPageLifecycle') : t('designer.components.lifeCycles.addBlockLifecycle') }}
        </tiny-button>
      </template>
  ...
  <tiny-dialog-box v-model:visible="state.showLifeCyclesDialog" fullscreen :show-close="false" :append-to-body="true">
    <template #title>
      <div class="bind-dialog-title">
        <div class="bind-dialog-text">
          {{ isPage ? t('designer.components.lifeCycles.addPageLifecycle') : t('designer.components.lifeCycles.addBlockLifecycle') }}
        </div>
        <div class="bind-dialog-btn">
          <tiny-button type="info" @click="editorConfirm">{{ t('designer.components.lifeCycles.save') }}</tiny-button>
    ...
    <div v-if="state.showLifeCyclesDialog" class="dialog-content">
      <div class="dialog-content-left">
        <tiny-search :placeholder="t('designer.components.lifeCycles.search')" @update:modelValue="searchLifeCyclesList"></tiny-search>
  ...
  setup(props, { emit }) {
    ...
    const deleteLifeCycle = (name) => {
      confirm({
        ...
        message: t('designer.components.lifeCycles.deleteConfirm', { name }),
        exec: () => {
