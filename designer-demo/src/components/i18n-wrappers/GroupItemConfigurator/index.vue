<template>
  <div class="meta-group-container">
    <label v-if="meta.label && !meta.label.hidden" class="meta-group-label">{{ labelText }}</label>
...
import { getLocalizedText, containsChinese, formatPropertyName } from '@/utils/i18nHelper';
