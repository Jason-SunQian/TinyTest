        ...
        >
            ...
            <template #operate="{ data }">
                <tiny-tooltip
                    class="item"
                    effect="light"
                    :content="t('designer.configurator.delete')"
                    placement="top"
                >
...
export default {
    ...
    setup() {
        ...
        const childComponentName =
            configureMap[componentName]?.nestingRule?.childWhitelist?.[0] ||
            schemaChildren?.[0]?.componentName;
        ...
        const updateChildrenToValid = () => {
            ...
            const newChildren = schemaChildren.map(item => {
                if (!item.props) {
                    ...
                    item.props = {
                        title: t('designer.configurator.defaultTabTitle'),
                        name: ''
                    };
                }
    ...
    .tabs-header-id {
        ...
        &::before {
            ...
            background-color: var(
                --te-configurator-container-border-color-divider
            );
        }
    }
}
