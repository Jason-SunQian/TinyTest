    ...
    >
      <div class="attr-form">
        ...
        <tiny-form label-position="left" label-width="53px">
          ...
          <div class="footer">
            <tiny-button size="small" @click="cancel">{{ cancelText }}</tiny-button>
            <tiny-button size="small" type="primary" @click="save">{{ saveText }}</tiny-button>
          </div>
        </tiny-form>
      </div>

      <template #reference>
        <tiny-tooltip class="item" effect="light" :content="addAttrTooltip" placement="top">
