    ...
    <div :class="['plugin-panel-header', headerBottomLine]">
      ...
      <div class="plugin-panel-icon">
        ...
        <tiny-tooltip
          ...
          effect="light"
          :content="isCollapsed ? t('designer.components.pluginPanel.expand') : t('designer.components.pluginPanel.collapse')"
          placement="top"
          :visible-arrow="false"
        >
          <template #default>
        ...
        <svg-button
          ...
          :tips="!fixedPanels?.includes(fixedName) ? t('designer.components.pluginPanel.pin') : t('designer.components.pluginPanel.unpin')"
          @click="fixPanel"
        ></svg-button>
        <close-icon v-if="!isCloseLeft" :name="name" @close="closePanel"></close-icon>
      </div>
