                ...
                >
                    ...
                    >
                        ...
                        >
                            <template #content>
                                <span>{{
                                    translate(item[itemsOptions.textField]) ||
                                    item.type
                                }}</span>
                            </template>
                            <template #metaForm>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const columnsList = computed(() => {
            return (
                props.meta.widget.props.modelValue?.value ||
        ...
        const addItem = () => {
            ...
            const newOption = ['string', 'boolean', 'number'].includes(
                props.meta.widget.props.type
            )
                ? defaultValue
                : { ...defaultValue };
