...
} from './src/plugins/singlePage/Main.vue';
...
import CustomMaterials, {
    ResourceService,
    MaterialService
} from './src/plugins/materials/index';
...
export default {
    ...
    'engine.plugins.customBlockManage': {
        ...
        // 这个会在 MainImpl.vue 中被 t('designer.leftPanel.blockManagement') 覆盖
        title: 'BlockManage',
        type: 'plugins',
    ...
    'engine.plugins.customCollections': {
        ...
        // 这个会在 Main.vue 中被 t('designer.datasource.title') 覆盖
        title: 'Collections',
        type: 'plugins',
