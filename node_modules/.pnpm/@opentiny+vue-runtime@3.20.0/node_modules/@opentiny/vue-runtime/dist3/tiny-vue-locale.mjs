...
var pe = Object.prototype.toString, Y = Object.prototype.hasOwnProperty, He = Object.getPrototypeOf, ge = Y.toString, qe = ge.call(Object), je = {
  "[object Error]": "error",
  ...
  return x(e) ? String(e) : je[pe.call(e)] || "object";
}, te = function(e) {
  return P(e) === "object";
}, y = function(e) {
  if (!e || pe.call(e) !== "[object Object]")
    return !1;
  var t = He(e);
  if (!t)
    return !0;
  ...
  if (l > 1) {
    l--;
    for (var c = i, u, d, m = 0; m < l; m++)
      u = a[m], d = c[u], (d === null || !y(d)) && (c[u] = {}, d = c[u]), c = d;
    s = a[l], o && y(c[s]) ? k(!0, c[s], n) : c[s] = n;
  } else
    o && y(i[s]) ? k(!0, i[s], n) : i[s] = n;
  return i;
}, Be = function(e, t, n, o) {
  var a = function l(s, c, u, d, m) {
    var f = d.indexOf(u) === 0, h = d.split(u), v = h[1] && h[1].indexOf(".") === 0;
    u === d || f && v ? u !== d && re(U(s, u), function(w) {
      return l(s, c, "".concat(u, ".").concat(w), d), !0;
    }) : t && !t.includes(u) && ne(c, u, U(s, u), m);
  }, i = function(s, c, u, d) {
    var m = {};
...
k = function() {
  ...
  for (P(a) === "boolean" && (l = a, a = t[i] || {}, i++), !te(a) && P(a) !== "function" && (a = {}); i < o; i++) {
    var s = t[i];
    if (s !== null && te(s))
      for (var c = Object.keys(s), u = 0, d = c; u < d.length; u++) {
        var m = d[u], f = a[m], h = s[m];
        a !== h && Ge(a, m, l, h, f);
      }
  }
  return a;
};
var C = O, A = null, R = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
  if (A)
    return A.apply(this, arguments);
  for (var n = e.split("."), o = null, a = C, i = 0, l = n.length; i < l; i++) {
    var s = n[i];
    if (o = a[s] || "", i === l - 1)
      return Ue(o, t);
    if (!o)
  ...
  typeof s != "function" && (s = function(m) {
    var f = m.lang, h = m.i18n, v = m.messages;
    return K(!0, f, h.messages, v);
  });
  var c = {
    zhCN: O,
    enUS: W
  ...
  if (typeof n == "function") {
    ...
    return A = function(m, f) {
      return u.global.t(m, f);
    }, u;
  }
  return t && t.config && t.config.globalProperties && (t.config.globalProperties.$t = R), s({
    lang: c,
    i18n: l,
    messages: a
  });
...
}, be = typeof window < "u" && typeof document < "u" && window.document === document;
(function() {
  var r = {
    name: void 0,
    version: void 0,
  ...
  if (be) {
    ...
    var t;
    if (window.chrome && (window.chrome.webstore || /^Google\b/.test(window.navigator.vendor)) ? (r.name = "chrome", r.chrome = !0, t = navigator.userAgent.match(/chrome\/(\d+)/i), r.version = !!t && !!t[1] && parseInt(t[1], 10), t = void 0) : document.all || document.documentMode ? (r.name = "ie", r.version = Ze(), r.ie = !0) : typeof window.InstallTrigger < "u" ? (r.name = "firefox", r.firefox = !0) : Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0 ? (r.name = "safari", r.safari = !0) : (window.opr && window.opr.addons || window.opera) && (r.name = "opera", r.opera = !0), _e(r), !~["ie", "chrome"].indexOf(r.name)) {
      var n = r.name + "/(\\d+)";
...
var M = be ? window.BigInt : global.BigInt;
function B() {
...
function _(r, e) {
  return G.CLS || De(e), Je(new G.CLS(r));
}
var Qe = /* @__PURE__ */ function() {
  function r(e) {
    ...
    var t = Z(e) ? Number(e) : e;
    typeof t != "string" && we(t);
    var n = Function, o = function(c) {
      var u = c.replace(/^0+/, "") || "0";
      return n("return BigInt('".concat(u, "')"))();
    };
    if (Te(t)) {
      var a = F(t);
  ...
  return he(r, [{
    ...
    value: function(t) {
      ...
      if (n.isInvalidate())
        return this;
      var o = Math.max(this.getDecimalStr().length, n.getDecimalStr().length), a = n.alignDecimal(o), i = this.alignDecimal(o), l = "".concat(i + a), s = F(l), c = s.negativeStr, u = s.trimStr, d = "".concat(c).concat(u.padStart(o + 1, "0"));
      return _("".concat(d.slice(0, -o), ".").concat(d.slice(-o)));
    }
  }, {
    key: "negate",
    value: function() {
    ...
    value: function() {
      ...
      return t ? this.isInvalidate() ? "" : F("".concat(this.getMark()).concat(this.getIntegerStr(), ".").concat(this.getDecimalStr())).fullStr : this.origin;
    }
  }]), r;
...
function Ne(r, e) {
  ...
  if (r === "")
    return "";
  var n = ".", o = F(r), a = o.negativeStr, i = o.integerStr, l = o.decimalStr, s = "".concat(n).concat(l), c = "".concat(a).concat(i);
  if (e >= 0) {
    var u = Number(l[e]);
    if (u >= t && t !== 0) {
      var d = _("".concat(i).concat(n).concat(l)).add("0.".concat(ae("", e, !0)).concat(10 - u));
      return Ne(a + d.toString(), e, 0);
    }
    return e === 0 ? c : "".concat(c).concat(n).concat(ae(l, e, !0).slice(0, e));
  }
  return s === ".0" ? c : "".concat(c).concat(s);
}
var et = function(e, t) {
  var n = t.secondaryGroupSize, o = n === void 0 ? 3 : n, a = t.groupSize, i = a === void 0 ? 0 : a, l = t.groupSeparator, s = l === void 0 ? "," : l, c = /^-\d+/.test(e), u = c ? e.slice(1) : e, d = o || i;
  if (i && u.length > i) {
    var m = u.slice(0, 0 - i), f = u.slice(0 - i);
    m = m.replace(new RegExp("\\B(?=(\\d{".concat(d, "})+(?!\\d))"), "g"), s), u = "".concat(m).concat(s).concat(f);
  }
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = t.fraction, o = t.rounding, a = t.prefix, i = a === void 0 ? "" : a, l = t.decimalSeparator, s = l === void 0 ? "." : l, c = t.suffix, u = c === void 0 ? "" : c, d = _(e);
  if (d.isNaN() || !d.toString())
    return e;
  d = Ne(d.toString(), n, o), t.zeroize === !1 && d.match(/\./) && (d = d.replace(/\.?0+$/g, ""));
  var m = d.toString().split(".").slice(0, 2).map(function(f, h) {
    return h ? tt(f, t) : et(f, t);
  }).join(s);
  return "".concat(i).concat(m).concat(u);
}, nt = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = t.prefix, o = n === void 0 ? "" : n, a = t.suffix, i = a === void 0 ? "" : a, l = t.decimalSeparator, s = l === void 0 ? "." : l, c = e;
  return typeof e == "string" && (c = e.replace(new RegExp("^".concat(o, "(.+)").concat(i, "$")), function(u, d) {
    return d;
  }).split(s).map(function(u) {
    return u.replace(/[^\d]/g, "");
  }).join(".")), Number(c);
}, Me = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], at = new RegExp("^(\\d{4})(/|-)(((0)?[1-9])|(1[0-2]))((/|-)(((0)?[1-9])|([1-2][0-9])|(3[0-1])))?( ((0)?[0-9]|1[0-9]|20|21|22|23):([0-5]?[0-9])((:([0-5]?[0-9]))?(.([0-9]{1,6}))?)?)?$"), ot = new RegExp("^(((0)?[1-9])|(1[0-2]))(/|-)(((0)?[1-9])|([1-2][0-9])|(3[0-1]))?(/|-)?(\\d{4})( ((0)?[0-9]|1[0-9]|20|21|22|23):([0-5]?[0-9])((:([0-5]?[0-9]))?(.([0-9]{1,6}))?)?)?$"), it = new RegExp("^(\\d{4})-(((0)?[1-9])|(1[0-2]))-(((0)?[1-9])|([1-2][0-9])|(3[0-1]))T(((0)?[0-9]|1[0-9]|20|21|22|23):([0-5]?[0-9])((:([0-5]?[0-9]))?(.([0-9]{1,6}))?)?)?(Z|([+-])((0)?[0-9]|1[0-9]|20|21|22|23):?([0-5]?[0-9]))$"), b = {
  YEAR: 9999,
  MONTH: 11,
  DATE: 31,
  HOUR: 23,
  ...
  SECOND: 59,
  MILLISECOND: 999
}, lt = "-12:00,-11:00,-10:00,-09:30,-08:00,-07:00,-06:00,-05:00,-04:30,-04:00,-03:30,-02:00,-01:00", st = "-00:00,+00:00,+01:00,+02:00,+03:00,+03:30,+04:00,+04:30,+05:00,+05:30,+05:45,+06:00", ut = "+06:30,+07:00,+08:00,+09:00,+10:00,+10:30,+11:00,+11:30,+12:00,+12:45,+13:00,+14:00", ct = [].concat(lt.split(","), st.split(","), ut.split(",")), ke = function(e) {
  return e % 400 === 0 || e % 4 === 0 && e % 100 !== 0;
}, xe = function(e) {
  return e > b.MILLISECOND ? Number(String(e).substring(0, 3)) : e;
}, J = function(e) {
  var t = e.year, n = e.month, o = e.date, a = e.hours, i = e.minutes, l = e.seconds, s = e.milliseconds, c = Me[n];
  if (ke(t) && n === 1 && (c += 1), o <= c)
  ...
  if (e.length === 25) {
    var t = Number(e[1]), n = e[2] - 1, o = Number(e[6]), a = new Date(t, n, o).getTimezoneOffset(), i = e[12] || 0, l = e[14] || 0, s = e[17] || 0, c = e[19] || 0, u = e[20], d = e[21], m = e[22] || 0, f = e[24] || 0, h = Me[n], v, w;
    if (ke(t) && n === 1 && (h += 1), o <= h) {
      if (u === "Z")
        v = i - a / 60, w = l;
      else {
        if (u.includes(":") || (u = u.substr(0, 3) + ":" + u.substr(3)), !ct.includes(u))
          return;
        v = d === "+" ? i - m - a / 60 : Number(i) + Number(m) - a / 60, w = d === "+" ? l - f : Number(l) + Number(f);
      }
      return new Date(t, n, o, v, w, s, xe(c));
    }
  }
}, H = [[at, dt], [ot, mt], [it, ft]], ht = function(e) {
  ...
  for (var o = 0, a = 0, i = 0, l = e.length; i < l; i++) {
    var s = e.substr(i, 1), c = isNaN(Number(s)) || s.trim() === "";
    if (c && s === t.substr(i, 1) || i === l - 1) {
      var u = void 0, d = void 0;
      if (c) {
        u = e.substring(o, i), o = i + 1;
        var m = t.indexOf(s, a);
        d = t.substring(a, m === -1 ? t.length : m), a = m + 1;
      } else
        u = e.substring(o, l), d = t.substring(a, l);
      (u.length === d.length || u) && pt(n, u, d);
    }
  }
  return n;
}, D = function(e, t, n) {
  ...
  return D(t, 0, b.YEAR) || D(n, 0, b.MONTH) || D(o, 0, b.DATE) || D(a, 0, b.HOUR) || D(i, 0, b.MINUTE) || D(l, 0, b.SECOND) || D(s, 0, b.MILLISECOND);
}, yt = function(e, t) {
  if (typeof t == "string") {
    var n = gt(e, t), o = Number(n[0]), a = Number(n[1]), i = Number(n[2] || 1), l = Number(n[3] || 0), s = Number(n[4] || 0), c = Number(n[5] || 0), u = Number(n[6] || 0);
    return vt({
      year: o,
      month: a,
      date: i,
...
}, bt = "date,datetime,time,time-select,week,month,year,years,yearrange,daterange,monthrange,timerange,datetimerange,dates,quarter", z = {
  Day: "day",
  Date: "date",
  Dates: "dates",
  Year: "year",
...
}, g = {}, Q = ["\\d\\d?", "\\d{3}", "\\d{4}"], S = Q[0], Tt = Q[1], wt = Q[2], E = "[^\\s]+", Ee = /\[([^]*?)\]/gm, le = function() {
}, Dt = {
  shortDate: "M/D/yy",
  ...
  return e.replace(/[|\\{()[^$+*?.-]/g, "\\$&");
}, Fe = /d{1,4}|M{1,4}|yy(?:yy)?|S{1,3}|Do|ZZ|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g, Ae = z.fullWeeks, ze = z.fullMonths, Mt = Ce(ze, 3), kt = Ce(Ae, 3), xt = ["th", "st", "nd", "rd"];
g.i18n = {
  dayNames: Ae,
  monthNames: ze,
  dayNamesShort: kt,
...
Et.forEach(function(r) {
  r === "MM" ? T[r] = T[r.substr(0, 1)] : T[r] = T[r.substr(0, 1).toLowerCase()];
});
g.format = function(r, e, t) {
  var n = t || g.i18n;
  if (typeof r == "number" && (r = new Date(r)), !I(r) || isNaN(r.getTime()))
    throw new Error("Invalid Date in fecha.format");
  e = g.masks[e] || e || g.masks.default;
  var o = [];
  return e = e.replace(Ee, function(a, i) {
    return o.push(i), "@@@";
  }), e = e.replace(Fe, function(a) {
    return a in ue ? ue[a](r, n) : a.slice(1, a.length - 1);
  }), e.replace(/@@@/g, function() {
    return o.shift();
  });
};
var Ct = function(e, t) {
  var n = [], o = Nt(e).replace(Fe, function(a) {
    if (T[a]) {
      var i = T[a];
  ...
  if (x(e.timezoneOffset)) {
    var d = e.year, m = e.month, f = e.day, h = e.hour, v = e.minute, w = e.second, Ie = e.millisecond;
    t = new Date(d || n.getFullYear(), m || 0, f || 1, h || 0, v || 0, w || 0, Ie || 0);
  } else {
    e.minute = Number(e.minute || 0) - Number(e.timezoneOffset);
    var o = e.year, a = e.month, i = e.day, l = e.hour, s = e.minute, c = e.second, u = e.millisecond;
    t = new Date(Date.UTC(o || n.getFullYear(), a || 0, i || 1, l || 0, s || 0, c || 0, u || 0));
  }
  return t;
};
g.parse = function(r, e, t) {
  ...
  if (e = g.masks[e] || e, r.length > 1e3)
    return null;
  var o = {}, a = [];
  e = e.replace(Ee, function(u, d) {
    return "@@@";
  });
  var i = Ct(e, a), l = r.match(new RegExp(i, "i"));
  if (!l)
    return null;
  for (var s = 1, c = l.length; s < c; s++)
    a[s - 1](o, l[s], n);
  return o.isPm === !0 && !x(o.hour) && Number(o.hour) !== 12 ? o.hour = Number(o.hour) + 12 : o.isPm === !1 && Number(o.hour) === 12 && (o.hour = 0), Ft(o);
};
const At = g;
var ce = z.Weeks, de = z.MonhtList, zt = z.DateFormats.date, Pt = function(e) {
  return {
    dayNamesShort: ce.map(function(t) {
      return e("ui.datepicker.weeks.".concat(t));
    }),
    dayNames: ce.map(function(t) {
      return e("ui.datepicker.weeks.".concat(t));
    }),
  ...
  return It(e) ? new Date(e) : null;
}, Rt = function(e, t, n) {
  return e = Ot(e), e ? At.format(e, t || zt, Pt(n)) : "";
}, Lt = function(e) {
  var t = 3, n = ",", o = ".";
  if (y(e))
    return e;
...
}, Pe = /(-|\+)(\d{2}):?(\d{2})$/, q = function(e) {
  var t = 0 - (/* @__PURE__ */ new Date()).getTimezoneOffset() / 60, n = typeof e == "string" && e.match(Pe);
  if (n) {
  ...
  return function(e) {
    var t = N(N({}, Ut(e)), {}, {
      ...
      formatDate: function(a, i) {
        if (x(a))
          return a;
        var l = I(a) ? a : ie(a), s = t.DbTimezone, c = a.match && a.match(Pe), u = i === !1 || arguments[2] === !1;
        return c && (s = q(a), l = ie(a.replace("T", " ").slice(0, -5))), u || (l = this.getDateWithNewTimezone(l, s, t.Timezone, t.TimezoneOffset)), I(l) ? Rt(l, i || t.DateFormat, r) : null;
      },
      /**
       *
      ...
      formatNumber: function(a, i) {
        return rt(a, N(N({}, t.NumberFormat), i));
      },
      /**
       *
      ...
      recoverNumber: function(a, i) {
        return nt(a, N(N({}, t.NumberFormat), i));
      },
      /**
       *
      ...
      getDateWithNewTimezone: function(a, i, l, s) {
        return i = i === 0 ? i : i || t.DbTimezone, l = l === 0 ? l : l || t.Timezone, s = s === 0 ? s : s || t.TimezoneOffset, St(a, i, l, s);
      }
    };
    return n;
  };
...
const $t = "3.20.0";
var Gt = ve, qt = R, Wt = ye, Yt = Se, Vt = K, Kt = O, Zt = W, jt = We, Bt = /* @__PURE__ */ Ht(qt), _t = /* @__PURE__ */ Object.assign({}, Ke, {
  language: jt,
  globalization: Bt
});
export {
